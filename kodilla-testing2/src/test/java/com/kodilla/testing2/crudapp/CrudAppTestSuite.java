...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://ankleszczewski.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("andrzejkleszczewski");
        driverTrello.findElement(By.id("password")).sendKeys("sun20044");
